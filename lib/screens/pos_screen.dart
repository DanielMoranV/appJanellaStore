  ...
  Future<void> _finalizarVenta(bool esCredito) async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Venta ${esCredito ? "a crédito" : "en efectivo"} registrada'),
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        ...
                        subtitle: Text(
                          ...
                          style: TextStyle(
                            color: producto.stock < 5 ? Colors.orange : Colors.grey[600],
                          ),
                        ),
                        trailing: Row(
                          ...
                          children: [
                            Text(
                              AppConstants.currencyFormat.format(producto.precioVenta),
                              style: const TextStyle(
                                fontSize: 16,
                                fontWeight: FontWeight.bold,
                                color: Colors.green,
                            ...
                            IconButton(
                              ...
                              icon: Icon(
                                enCarrito ? Icons.check_circle : Icons.add_circle,
                          ...
                          trailing: Row(
                            ...
                            children: [
                              IconButton(
                                ...
                                onPressed: () => cart.decrementQuantity(item.producto.idProducto),
                              ),
                              Text('${item.cantidad}', style: const TextStyle(fontSize: 16)),
                              IconButton(
                                icon: const Icon(Icons.add_circle_outline, size: 20),
                                onPressed: () => cart.incrementQuantity(item.producto.idProducto),
                              ),
                              IconButton(
                                icon: const Icon(Icons.delete, size: 20, color: Colors.red),
                                onPressed: () => cart.removeProduct(item.producto.idProducto),
                              ),
                            ],
                          ),
                        );
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              AppConstants.currencyFormat.format(cartState.total),
                              style: const TextStyle(
                                fontSize: 28,
                                fontWeight: FontWeight.bold,
                                color: Colors.green,
